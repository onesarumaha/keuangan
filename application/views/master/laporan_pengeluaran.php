      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <div class="card card-secondary">
            ...
            <form action="<?php echo base_url() ?>laporan/periode_pengeluaran" method="post" target="_blank">
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <a href="<?php echo base_url() ?>laporan/full_pengeluaran" class="btn btn-primary" target="_blank">Cetak</a>
              </div>
            </form>
          </div>
          <hr>
          ...
          <table class="table table-hover">
            ...
            <?php 
            $no = 1;
            foreach($lap_pengeluaran as $lap) : ?>
            <tbody>
              <tr>
                <td class="text-center"><?= $no++; ?></td>
                <td class="text-center"><?= $lap['tgl'];?></td>
                <td class="text-center"><?= $lap['keterangan']; ?></td>
                <td class="text-center"><?= $lap['jenis_pengeluaran']; ?></td>
                <td class="text-center"><?= $lap['jumlah']; ?></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          <tr>
          <th colspan="4"><b>Total Pengeluaran</b></th>
