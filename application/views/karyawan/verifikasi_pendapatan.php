		...
		<div class="container-fluid">
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Verifikasi Pendapatan</h3>
				</div>
				...
				<form class="navbar-form navbar-right" action="" method="post">
					<div class="input-group">
						 <input type="text" class="form-control" name="cari3" placeholder="Pencarian ...">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"> 
									<a class="cek-pendapatan" href="<?= base_url('Karyawan/ver_pendapatan/') ?><?= $row['id_transaksi'] ?>"><button class="btn btn-success"><i class="fa fa-check-circle"></i></button></a> |
									
									<a class="tombol-hapus" href="<?= base_url('Karyawan/hapus_pendapatan/') ?><?= $row['id_transaksi'] ?>"><button class="btn btn-danger"><i class="fa fa-trash-o"></i></button></a>
								</td>
