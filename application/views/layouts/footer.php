<!-- END MAIN -->
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">Sistem Informasi Keuangan <i class="fa fa-love"></i><a href="#">Skripsi 2020</a>
</p>
			</div>
		</footer>
	</div>
	...
	<script type="text/javascript" src="<?= base_url() ?>/assets/dist/myalert.js"></script>
